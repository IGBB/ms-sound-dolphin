...
#+HEADER: :results output graphics file
#+HEADER: :file supp-fig-9.mtCR-msn.png
#+header: :width 9 :height 9 :units in :bg white :res 300
#+begin_src R :exports both
library(pegas)
library(tidyverse)
library(poppr)
...
#+caption: Minimum Spanning Network for the mtCR haplotypes. Filled vertices are haplotypes found in the newly seqeunces samples. The vertices with five or more samples are labeled.
#+RESULTS:
[[file:supp-fig-9.mtCR-msn.png]]

** whole mitogenome Minimum Spanning Network
#+HEADER: :results output graphics file
#+HEADER: :file supp-fig-10.mito-msn.png
#+header: :width 10 :height 10 :units in :bg white :res 300
#+begin_src R :exports both
library(pegas)
library(tidyverse)
library(poppr)
...
#+caption: Minimum Spanning Network for the whole mitogenome  haplotypes. The vertices with five or more samples are labeled.
#+RESULTS:
[[file:supp-fig-10.mito-msn.png]]
